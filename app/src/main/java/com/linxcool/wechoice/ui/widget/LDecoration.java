...
/**
 * Created by huchanghai on 2016/9/21.
 */
public class LDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public LDecoration(Context context, int orientation) {
     ...
     */
    public LDecoration(Context context, int orientation, int drawableId) {
     ...
     */
    public LDecoration(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (divider != null) {
                divider.setBounds(left, top + padding, right, bottom - padding);
                divider.draw(canvas);
            }
            if (paint != null) {
