...
public class FormatUtil {
    ...
    public static boolean isMobileNo(String mobiles) {
	    ...
	    总结起来就是第一位必定为1，第二位必定为2或3或5或8或7，其他位置的可以为0-9
		 */
        String telRegex = "[1][234578]\\d{9}";
     ...
     */
    public static Pair<Boolean, String> validateIDCard(String idno) throws ParseException {
        // 记录错误信息
        String errorInfo = "";
        ...
        if (idno.length() != 15 && idno.length() != 18) {
            ...
            return new Pair<>(false, errorInfo);
        }
        ...
        if (isDateFormat(strYear + "-" + strMonth + "-" + strDay) == false) {
            errorInfo = "身份证生日无效。";
            return new Pair<>(false, errorInfo);
        }
        ...
        return new Pair<>(true, errorInfo);
    }
